...
class Factura(models.Model):
    ...
    id_publicidad = models.ForeignKey('Publicidad', models.DO_NOTHING, db_column='id_publicidad')
...
class Pago(models.Model):
    ...
    id_banco = models.ForeignKey(Bancoaliado, models.DO_NOTHING, db_column='id_banco')
...
class Publicidad(models.Model):
    id_publicidad = models.IntegerField(primary_key=True)
